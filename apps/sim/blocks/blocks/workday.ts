...
export const WorkdayBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Build a workflow that watches a Ame table of approved promotions, transfers, and demotions, performs the Workday change-job action for each row, updates downstream tools and Slack channel membership, and writes the outcome back to the table for audit.',
      modules: ['tables', 'agent', 'workflows'],
      category: 'operations',
