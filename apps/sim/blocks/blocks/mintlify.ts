...
export const MintlifyBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that searches a Mintlify documentation site, fetches the full content of each matching page, and loads it into a Ame knowledge base so agents can retrieve it offline.',
