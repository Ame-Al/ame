...
export const MSSQLBlockMeta = {
  ...
  templates: [
    ...
    {
      icon: MicrosoftSqlIcon,
      title: 'SQL Server results to Ame table',
      prompt:
        'Create a scheduled workflow that runs a Microsoft SQL Server query for the latest records and writes each row into a Ame table, so the data is available for downstream blocks without a live database call.',
