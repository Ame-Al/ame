  ...
  templates: [
    {
      ...
      prompt:
        'Create a scheduled workflow that runs a saved AWS Athena query daily, writes the result rows to a Ame table, and posts a Slack summary of the top movers.',
