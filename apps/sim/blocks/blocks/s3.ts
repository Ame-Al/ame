...
export const S3BlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that lists objects in an S3 bucket, downloads each new document, and indexes it into a Ame knowledge base so agents can answer questions over files stored in S3.',
