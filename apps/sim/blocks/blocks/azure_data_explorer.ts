...
export const AzureDataExplorerBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled workflow that lists every Azure Data Explorer database and table, reads their schemas, and keeps a Ame table up to date as a searchable data-model catalog with a note on what changed since the last run.',
