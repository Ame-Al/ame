  ...
  templates: [
    {
      ...
      prompt:
        'Build a scheduled workflow that reads the Wealthbox contacts and tasks listed by ID in a Ame table, refreshes each row with the latest details, and keeps the table in sync for unified reporting.',
