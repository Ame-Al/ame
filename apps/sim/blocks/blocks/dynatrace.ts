...
export const DynatraceBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled daily workflow that lists open critical and high Dynatrace security problems, groups them by affected service and CVE, writes them to a Ame table, and posts a remediation digest to the security channel in Slack.',
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled weekly workflow that queries Dynatrace host CPU, memory, and disk metrics per management zone, ranks the most saturated hosts, and writes a capacity planning report to a Ame table.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'engineering',
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled workflow that checks Dynatrace problems whose entities have returned to a healthy metric baseline, closes them with an explanatory comment, and records what was closed in a Ame table for review.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'operations',
