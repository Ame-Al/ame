  ...
  templates: [
    {
      ...
      prompt:
        'Build a workflow that triggers Apify scrapers on a schedule, captures the output, transforms into structured rows, and writes them to a downstream Ame table.',
