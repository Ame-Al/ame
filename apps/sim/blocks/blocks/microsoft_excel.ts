...
export const MicrosoftExcelBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled workflow that updates a Microsoft Excel data table from a Ame source, refreshes the dependent Power BI dataset, and notifies BI consumers in Teams.',
      modules: ['scheduled', 'agent', 'workflows'],
      category: 'operations',
      tags: ['reporting', 'enterprise'],
      alsoIntegrations: ['microsoft_teams'],
