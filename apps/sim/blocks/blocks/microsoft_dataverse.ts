  ...
  templates: [
    {
      ...
      prompt:
        'Build a scheduled workflow that mirrors records between Microsoft Dataverse and a Ame table, normalizes schemas, and posts conflict reports to Slack.',
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that pulls Dataverse entity data daily, transforms it into BI-ready rows in a Ame table, and stages a refresh signal for downstream Power BI consumption.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'operations',
