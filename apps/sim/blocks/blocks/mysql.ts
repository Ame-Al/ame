...
export const MySQLBlockMeta = {
  ...
  templates: [
    ...
    {
      icon: Database,
      title: 'Sync records from a Ame table into MySQL',
      prompt:
        'Create a workflow that reads rows from a Ame table and upserts each one into a MySQL table — updating the row when a matching key exists and inserting it otherwise — so the two stay in sync.',
