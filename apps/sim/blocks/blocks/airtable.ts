  ...
  templates: [
    {
      ...
      prompt:
        'Create a scheduled workflow that syncs records from my Airtable base into a Ame table every hour, keeping both in sync. Use an agent to detect changes, resolve conflicts, and flag any discrepancies for review in Slack.',
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled workflow that mirrors records between an Airtable base and a Ame table, detects conflicts, and pings Slack on records that need manual resolution.',
