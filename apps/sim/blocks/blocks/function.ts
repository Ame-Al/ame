...
try {
  ...
  throw error;
    ...
    },
    {
      ...
      description:
        'Ame sandbox dependencies, system packages, and managed CLIs available to this block. Shell can use Ame sandboxes from either language. Manage them in Settings > Sandboxes. Leaving this empty runs on the default image.',
    },
    {
      id: 'secretScope',
      title: 'Secret access',
  ...
  inputs: {
    ...
    sandboxId: {
      type: 'string',
      description:
        'Ame sandbox providing dependencies, system packages, and managed CLIs. Selecting or clearing it requires an active Max or Enterprise plan.',
    },
