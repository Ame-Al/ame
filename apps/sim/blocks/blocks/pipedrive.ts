  ...
  templates: [
    {
      ...
      prompt:
        'Create a scheduled workflow that mirrors Pipedrive deals into a Ame table, calculates pipeline velocity per stage, and posts a daily Slack summary of deals at risk.',
