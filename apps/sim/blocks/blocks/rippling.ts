...
export const RipplingBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that reads rows from a Ame table representing custom Rippling objects — perks, equipment, allowances — and upserts them into Rippling so HR can manage company-specific data with the same governance as core worker records.',
