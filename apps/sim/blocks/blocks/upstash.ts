...
export const UpstashBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled workflow that pops queued jobs from an Upstash Redis list with LRANGE, transforms each into structured rows, and writes them into a downstream Ame table for further automation.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'engineering',
      tags: ['devops', 'sync'],
    },
