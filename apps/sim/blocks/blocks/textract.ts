...
export const TextractBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Build a workflow that pushes scanned forms from Google Drive through AWS Textract analyze-document, extracts key-value pairs and tables, and writes structured rows to a Ame table for downstream automations.',
      modules: ['tables', 'files', 'agent', 'workflows'],
      category: 'operations',
