...
export const EnrichmentBlock: BlockConfig<EnrichmentRunResponse> = {
  ...
  description: 'Enrich data with a Ame enrichment',
  longDescription:
    'Run a Ame enrichment to look up data — work email, phone number, company domain, company info, and more — from the fields you map in. Uses the same provider cascade as table enrichments.',
