...
export const SplunkBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled workflow that runs a Splunk search for the previous hour of transaction logs and writes the results into a Ame table for downstream reporting.',
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled monthly workflow that lists every Splunk saved search, flags scheduled searches that have not run recently or are disabled, and writes a cleanup queue to a Ame table.',
