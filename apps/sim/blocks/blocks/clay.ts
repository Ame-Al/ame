  ...
  templates: [
    {
      ...
      prompt:
        'Build a workflow that reads a list of target prospects from a Ame table and pushes each one to a Clay table via the populate webhook, so Clay enriches them with role and intent signals through its own waterfall.',
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled workflow that reads target accounts from a Ame table and pushes each one to a Clay table via the populate webhook, so Clay enriches them with hiring, funding, and tech-change signals through its waterfall.',
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that reads a prospect record from a Ame table — including the role and company signals already gathered — drafts a personalized first-touch email, queues it for review, and pushes the prospect to a Clay table via the populate webhook for further enrichment.',
      modules: ['tables', 'agent', 'workflows'],
      category: 'sales',
