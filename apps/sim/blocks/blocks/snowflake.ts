...
export const SnowflakeBlock: BlockConfig<SnowflakeStatementResponse> = {
  ...
  inputs: {
    ...
    maxRows: { type: 'number', description: 'Maximum result rows (Ame safety limit: 10000)' },
  },
  outputs: {
