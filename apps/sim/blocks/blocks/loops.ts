...
export const LoopsBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled workflow that reads a Ame table of user activity to find accounts inactive for 90 days, updates each contact in Loops to the dormant user group and unsubscribes them from non-essential mailing lists, and writes a hygiene report to a table.',
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled workflow that reads a Ame table of contacts missing key custom properties, enriches each one using Clay or web research, updates the matching contact in Loops with the new properties, and tracks enrichment coverage in a table.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'marketing',
    ...
    },
    {
      ...
      prompt:
        'Build a scheduled workflow that reads a Ame table of product-usage data to identify users who have gone inactive, sends each a personalized transactional win-back email through Loops, fires a re-engagement event, and logs who was contacted to a table for follow-up.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'marketing',
      tags: ['marketing', 'automation', 'communication'],
    },
