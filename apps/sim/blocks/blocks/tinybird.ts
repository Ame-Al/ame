  ...
  templates: [
    {
      ...
      prompt:
        'Create a workflow that calls a Tinybird published pipe with parameters on a schedule, normalizes the results, and writes them into a Ame table for downstream consumers.',
    ...
    },
    {
      ...
      prompt:
        'Build a workflow that exposes a Tinybird endpoint reporting per-customer usage for billing, refreshes a Ame table hourly, and surfaces top consumers to Slack.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'operations',
