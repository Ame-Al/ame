...
export const QdrantBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that mirrors a Ame knowledge base into a Qdrant collection so downstream applications outside Ame can perform retrieval against the same vectors.',
