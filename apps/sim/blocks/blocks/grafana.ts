...
export const GrafanaBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a workflow that runs a set of Grafana data source queries on schedule and writes the returned series into a Ame table, so the metrics can be combined with business data for unified reporting.',
      modules: ['scheduled', 'tables', 'agent', 'workflows'],
      category: 'engineering',
      tags: ['analysis', 'sync'],
    },
