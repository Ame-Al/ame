...
export const AttioBlockMeta = {
  ...
  templates: [
    ...
    },
    {
      ...
      prompt:
        'Create a scheduled workflow that mirrors Attio deals into a Ame table, calculates pipeline velocity per stage, and posts a daily Slack summary of deals at risk.',
