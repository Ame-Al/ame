...
export const SETTINGS_SECTION_REGISTRY: readonly SettingsSectionRegistryEntry[] = [
  ...
  },
  {
    ...
    unified: {
      id: 'apikeys',
      description: 'Create and manage API keys for the Ame API.',
      group: 'workspace',
      order: 7,
    },
    planes: {
      account: {
        id: 'api-keys',
        description: 'Create and manage your personal Ame API keys.',
        group: 'developer',
        order: 2,
      },
      workspace: {
  ...
  },
  {
    ...
    unified: {
      id: 'self-host',
      description: 'Manage this deployment from the Ame managed service.',
      group: 'platform',
      order: 2,
  ...
  },
  {
    ...
    unified: {
      id: 'mothership',
      description: 'Internal Ame operations and license management.',
      group: 'platform',
      order: 1,
      requiresAdminRole: true,
    },
