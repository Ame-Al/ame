...
> This is a technical deep‑dive scaffold for Ame Copilot. We’ll keep updating it as we publish more results and open up additional capabilities.

## TL;DR

- Copilot is a context‑aware assistant embedded into the Ame editor.
...
- Works with the same permissions model you already use in Ame.
