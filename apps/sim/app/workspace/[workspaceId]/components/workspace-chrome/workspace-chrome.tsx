...
const CONTENT_PANE_FLUSH =
  '[[data-ame-desktop-title-bar=inset]_[data-sidebar-collapsed]_&]:rounded-none [[data-ame-desktop-title-bar=inset]_[data-sidebar-collapsed]_&]:border-0'
...
function TitleBarHistoryNav() {
  ...
  return (
    <div className='absolute top-[var(--desktop-title-bar-control-offset)] left-[calc(var(--desktop-title-bar-inset-x)+var(--desktop-title-bar-control-size)+4px)] z-30 hidden h-[var(--desktop-title-bar-control-size)] items-center gap-[2px] [-webkit-app-region:no-drag] [[data-ame-desktop-title-bar=inset]_&]:flex'>
      <button
        type='button'
        aria-label='Back'
        disabled={!can.back}
...
export function WorkspaceChrome({
  ...
  useLayoutEffect(() => {
    ...
    const initial = document.documentElement.getAttribute('data-ame-desktop-title-bar')
    ...
    >
      ...
      <div
        className={cn(
          ...
          SLIDE_TRANSITION,
          !isFullscreen && 'pl-0',
          isCollapsed && '[[data-ame-desktop-title-bar=inset]_&]:p-0'
        )}
        data-sidebar-collapsed={isCollapsed || undefined}
      ...
      {!isFullscreen && (
        ...
        <div
          ...
          className='absolute top-[var(--desktop-title-bar-control-offset)] left-[var(--desktop-title-bar-inset-x)] z-30 hidden size-[var(--desktop-title-bar-control-size)] [-webkit-app-region:no-drag] [[data-ame-desktop-title-bar=inset]_&]:block'
        >
          <SidebarTooltip
