          ...
          <div className='flex h-full flex-col'>
            ...
            <div
              className={cn(
                ...
                !isPeeking &&
                  '[[data-ame-desktop-title-bar=inset]_&]:pt-[var(--desktop-title-bar-height)]'
              )}
            >
              <WorkspaceHeader
              ...
              <div
                className={cn(
                  ...
                  isCollapsed
                    ? 'w-0 opacity-0'
                    : 'w-[65px] [[data-ame-desktop-title-bar=inset]_&]:w-[32px]'
                )}
              >
                <SidebarTooltip
                  label='Search'
                ...
                >
                  <Chip
                    ...
                    className={cn(
                      DRAG_EXEMPT_CLASS,
                      '[[data-ame-desktop-title-bar=inset]_&]:hidden'
                    )}
                  />
                </SidebarTooltip>
              </div>
