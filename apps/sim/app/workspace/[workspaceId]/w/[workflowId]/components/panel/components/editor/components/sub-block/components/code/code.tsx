...
IMPORTANT FORMATTING RULES:
1. Reference environment variables with the exact {{VARIABLE_NAME}} syntax. For a complete argument, prefer the unquoted placeholder; quoted and embedded forms are also supported. Ame supplies the exact value through a runtime environment binding instead of inserting it into the script source.
