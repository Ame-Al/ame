...
const IMPORT_ERROR_MESSAGES: Record<BrowserImportError, string> = {
  ...
  'keychain-unavailable':
    'Ame needs your permission to read that browser’s saved data. Allow the Keychain prompt and try again.',
  'profile-unreadable':
    'Could not read that browser’s data. Try quitting the other browser, then import again.',
  'unsupported-schema': 'That browser stores its data in a format Ame cannot read yet.',
