...
type McpClientType = 'ame' | 'cursor' | 'claude-code' | 'claude-desktop' | 'vscode'
              ...
              <div className='flex flex-col gap-4.5'>
                ...
                <div>
                  ...
                  >
                    ...
                    <ButtonGroupItem value='ame'>Ame</ButtonGroupItem>
                  </ButtonGroup>
                </div>
              ...
              <div className='flex flex-col gap-1.5'>
                ...
                <p className='text-[var(--text-muted)] text-caption'>
                  {editServerIsPublic
                    ...
                    : 'Requests must include your Ame API key in the X-API-Key header'}
                </p>
              </div>
            </ChipModalField>
          </ChipModalBody>
