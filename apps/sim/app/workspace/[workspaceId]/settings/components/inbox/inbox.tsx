    ...
    return (
      <SettingsPanel>
        <SettingsUpgradeNotice
          title='Ame Mailer requires an active Max plan'
          description='Upgrade to Max and ensure billing is active to receive tasks via email and let Ame work on your behalf.'
          canUpgrade={canAdmin}
        />
      </SettingsPanel>
    )
