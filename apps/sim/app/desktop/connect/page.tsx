...
export const metadata: Metadata = {
  title: 'Connect an account to Ame',
  robots: { index: false },
}
...
function InvalidRequest() {
  return (
    <DesktopHandoffShell
      ...
      description='Return to the Ame desktop app and start the connection again.'
    />
  )
}
  ...
  if (expectedUserId && session.user.id !== expectedUserId) {
    return (
      <DesktopHandoffShell
        ...
        description={`This browser is signed in as ${session.user.email}, but the connection was started from a Ame desktop app signed in as a different account. Switch accounts here to continue.`}
      >
        <SwitchAccount
