...
export async function generateMetadata({
  ...
  return buildLandingMetadata({
    title: `Ame vs ${competitor.name} | Ame, the AI Workspace`,
    description: `Compare Ame, the open-source AI workspace, to ${competitor.name} on platform, AI, integrations, pricing, security, and support. Sourced and dated facts.`,
    path: `/comparisons/${competitor.id}`,
    keywords: [
      `Ame vs ${competitor.name}`,
      `${competitor.name} alternative`,
      `${competitor.name} vs Ame`,
...
export default async function ComparisonProviderPage({
  ...
  const productComparisonJsonLd = {
    ...
    '@type': 'ItemList',
    name: `Sim vs ${competitor.name}`,
    description: `Feature and pricing comparison between Ame and ${competitor.name}.`,
        ...
        <div className='mx-auto w-full max-w-[1446px] px-12 pt-[112px] max-sm:px-5 max-sm:pt-20 max-lg:px-8'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='max-w-[720px] text-[var(--text-muted)] text-sm leading-[150%] tracking-[0.02em] lg:text-base'>
              ...
              visually, conversationally, or with code. Here is how Ame compares to{' '}
            ...
            <p className='sr-only'>
              Ame is an open-source AI workspace for building, deploying, and managing AI agents.
              This page compares Ame to {competitor.name} across platform architecture, AI
        ...
        <div className='mx-auto w-full max-w-[1446px]'>
          <div className='mx-12 border-[var(--border)] border-x max-sm:mx-5 max-lg:mx-8'>
            ...
            <section aria-labelledby='comparison-table-heading' className='px-6 py-10'>
              ...
              >
                Ame vs {competitor.name}: feature-by-feature comparison
              </h2>
              <ComparisonTable ame={simProfile} competitor={competitor} />
            </section>
