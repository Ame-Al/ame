...
const faqItems = [
  {
    question: 'How does Ame compare to workflow automation and AI agent platforms?',
    answer:
      'Ame is an open-source AI workspace where teams build, deploy, and manage AI agents visually, conversationally, or with code. Compared to workflow automation tools like n8n, Zapier, and Make, Ame treats AI agents as first-class building blocks rather than an add-on to data routing, and ships a native knowledge base, MCP support, and an in-editor AI Copilot. Compared to enterprise AI builders like Gumloop, Workato, StackAI, and Vellum, Ame is fully open source (Apache 2.0) and self-hostable, so teams can run it on their own infrastructure.',
  },
  {
    question: 'Is Ame open source?',
    answer:
  ...
  },
  {
    ...
    answer:
      "The right platform depends on what you're optimizing for: licensing and data control (Ame, n8n self-hosted), integration breadth (Zapier, Pipedream), enterprise governance (Workato, Tines), or AI-native agent building specifically (Ame, Gumloop, StackAI). Each comparison page on this site lays out sourced, dated facts across platform, AI capabilities, integrations, pricing, security, and support so you can weigh the tradeoffs for your team.",
  },
  {
    question: 'Is Ame free to use?',
    answer: `${ensurePeriod(simProfile.facts.pricing.freeTier.value)} Ame is also free to self-host under the Apache 2.0 license with no seat or usage limits beyond your own infrastructure.`,
  },
  {
    question: 'Does Ame support MCP (Model Context Protocol)?',
    answer: `${ensurePeriod(simProfile.facts.aiCapabilities.mcpSupport.value)} Ame can also publish any deployed workflow as its own MCP server, so it works as both an MCP client and an MCP server.`,
  },
  {
    question: 'How many integrations does Ame support?',
    answer: `Ame ships ${ensurePeriod(lowercaseFirst(simProfile.facts.integrations.integrationCount.value))} Combined with native MCP client support, teams can extend Ame to any service with a public API, not just the built-in catalog.`,
  },
]

export const metadata: Metadata = buildLandingMetadata({
  title: 'Ame Comparisons | Ame, the AI Workspace',
  description:
    'Compare Ame, the open-source AI workspace, to n8n, Zapier, Make, and other workflow automation and AI agent platforms. Sourced, dated, fact-checked.',
  path: '/comparisons',
  keywords: [
    'Ame comparison',
    'Ame vs n8n',
...
export default function ComparisonHubPage() {
  ...
  const itemListJsonLd = {
    ...
    description: 'Directory of Ame comparison pages against AI agent and workflow platforms.',
        ...
        <div className='mx-auto w-full max-w-[1446px] px-12 pt-[112px] max-sm:px-5 max-sm:pt-20 max-lg:px-8'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='max-w-[720px] text-[var(--text-muted)] text-sm leading-[150%] tracking-[0.02em] lg:text-base'>
              ...
              See how Ame compares to workflow automation platforms and AI agent builders on
              platform architecture, AI capabilities, integrations, pricing, security, and support.
            </p>
            <p className='sr-only'>
              This directory lists every Ame vs. competitor comparison page, covering workflow
                  ...
                  return (
                    <div key={competitor.id}>
                      <Link
                        ...
                        aria-label={`Ame vs ${competitor.name} comparison`}
                      >
                        {Icon ? (
                          <BrandIconTile
                            icon={Icon}
