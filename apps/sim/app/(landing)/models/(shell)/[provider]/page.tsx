...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Browse ${provider.modelCount} ${provider.name} models tracked in Ame. Compare pricing, context windows, default model selection, and capabilities for ${provider.name}'s AI model lineup.`,
    keywords: [
    ...
    openGraph: {
      title: `${provider.name} Models | Ame`,
...
export default async function ProviderModelsPage({
  ...
  const itemListJsonLd = {
    ...
    description: `List of ${provider.modelCount} ${provider.name} models tracked in Ame.`,
    url: `${baseUrl}${provider.href}`,
