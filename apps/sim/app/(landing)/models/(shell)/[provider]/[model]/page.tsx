...
export async function generateMetadata({
  ...
  return {
    ...
    description: `${model.displayName} by ${provider.name}: pricing, cached input cost, output cost, context window, and capability support. Explore the full generated model page on Ame.`,
    keywords: [
      model.displayName,
    ...
    openGraph: {
      title: `${model.displayName} Pricing, Context Window, and Features | Ame`,
