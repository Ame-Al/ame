...
export default async function Image({
  ...
  return createCoverOgImage({
    ...
    subtitle: `${provider.name} · ${formatPrice(model.pricing.input)}/1M in, ${formatPrice(model.pricing.output)}/1M out, ${formatTokenCount(model.contextWindow)} context — from Ame's model registry.`,
  })
}
