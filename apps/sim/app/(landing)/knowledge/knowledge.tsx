...
export const KNOWLEDGE_PAGE_DESCRIPTION =
  'Give AI agents a knowledge base in Ame. Upload docs, sync Notion, Google Drive, and Confluence, and get answers grounded in your data, with citations.'
...
const KNOWLEDGE_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    ...
    heading: "Give AI agents memory of your data with Ame's knowledge base.",
    description:
      "Knowledge Base is your agents' memory in Ame, the open-source AI workspace. Upload docs, sync sources like Notion and Google Drive, and get answers grounded in your data, with citations.",
    summary:
      'Knowledge Base is the agent-memory module in Ame, the open-source AI workspace where teams build, deploy, and manage AI agents. Teams upload docs or sync sources like Notion, Google Drive, and Confluence, and every agent answers from that data with citations, kept fresh automatically.',
    visual: (
      <PlatformHeroVisual>
        <KnowledgeHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle:
        'Ame turns your docs and sources into searchable memory every agent can read, so answers come from your data instead of guesswork.',
      cta: { label: 'Explore Knowledge Base', href: '/signup' },
      cards: [
        {
          title: 'Sync your sources',
          description:
            'Connect Notion, Google Drive, Confluence, and more. Ame pulls the documents in and keeps every source syncing on its own.',
          visual: <ConnectorSyncGraphic />,
        },
        {
          title: 'Answers grounded in your docs',
          description:
            'Agents in Ame answer from your knowledge base and cite the document behind every answer, so teams can check the source.',
          visual: (
        ...
        },
        {
          ...
          description:
            'Drop a knowledge search step into any workflow. Ame retrieves the passages the agent needs mid-run, in visual builds or in code.',
    ...
    },
    {
      ...
      subtitle:
        'Ame re-syncs your sources, processes every new document, and logs each update, so agent memory never drifts out of date.',
      cta: { label: 'See how syncing works', href: '/signup' },
      cards: [
        {
          title: 'Fresh without the upkeep',
          description:
            'Ame re-syncs each connected source on a schedule and records every update, so nobody has to re-upload a doc again.',
          visual: (
            <AuditTrailGraphic
              entries={[
                {
        ...
        },
        {
          ...
          description:
            'Ame splits each document into searchable passages and shows the work: source, passage count, tokens, and status for every file.',
          visual: (
            <RunMonitoringGraphic
        ...
        },
        {
          ...
          description:
            'Every agent in Ame reads from the same knowledge base, in Chat, in workflows, and in deployed agents, so answers stay consistent.',
          featureTileTone: 'dark',
          featureTileDescriptionTone: 'soft',
          visual: (
            <OperationsTeamsGraphic
