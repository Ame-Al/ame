...
export const TERMS_CONFIG: LegalPageConfig = {
  ...
  description:
    'The terms and conditions for using Ame, the open-source AI workspace: subscription plans, data ownership, and acceptable use.',
  lastUpdated: 'October 11, 2025',
  intro: [
    {
      kind: 'paragraph',
      content: `Please read these Terms of Service ("Terms") carefully before using the Ame platform (the "Service") operated by Ame, Inc ("us", "we", or "our").`,
    },
    {
      kind: 'paragraph',
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          content: `The Service and its original content, features, and functionality are and will remain the exclusive property of Ame, Inc and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries.`,
        },
        {
          kind: 'paragraph',
          content: `Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Ame, Inc.`,
        },
      ],
    },
    {
      ...
      blocks: [
        { kind: 'paragraph', content: `You agree not to use the Service:` },
        {
          ...
          items: [
            ...
            `To impersonate or attempt to impersonate Ame, Inc, a Ame employee, another user, or any other person or entity.`,
            `In any way that infringes upon the rights of others, or in any way is illegal, threatening, fraudulent, or harmful.`,
            `To engage in any other conduct that restricts or inhibits anyone's use or enjoyment of the Service, or which, as determined by us, may harm Ame, Inc or users of the Service or expose them to liability.`,
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          content: `In no event shall Ame, Inc, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:`,
        },
        {
          kind: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          content: `Ame, Inc, its subsidiaries, affiliates, and its licensors do not warrant that:`,
        },
        {
          kind: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          content: `Please read the following arbitration agreement carefully. It requires you to arbitrate disputes with Ame, Inc, its parent companies, subsidiaries, affiliates, successors and assigns and all of their respective officers, directors, employees, agents, and representatives (collectively, the "Company Parties") and limits the manner in which you can seek relief from the Company Parties.`,
        },
        {
          kind: 'paragraph',
