...
function buildFAQs(integration: Integration, relatedNames: string[]): FAQItem[] {
  ...
  const faqs: FAQItem[] = [
    {
      question: `What is Ame's ${name} integration?`,
      answer: `Ame's ${name} integration ${capabilityPhrase ? `adds ${capabilityPhrase} to` : `connects ${name} to`} the AI agents you build in Ame's visual workflow builder — you build it all visually. ${faqDescription}${
        pairings.length === 2
    ...
    ...(opCount > 0
      ? [
          {
            question: `What can I automate with ${name} in Ame?`,
            answer: `You can ${toProseList(topOpNames.map(lowercaseFirst))} with ${name} in Ame${
      ...
      : []),
    {
      question: `How do I connect ${name} to Ame?`,
      answer: `Connecting ${name} takes about five minutes: (1) Create a free account at ame.ai. (2) Create an agent in your workspace. (3) Drag ${articleFor(name)} ${name} block onto the workflow builder. (4) ${AUTH_STEP[authType](name)} (5) ${connectFinalStep}`,
    },
    ...(firstOp && opCount >= 2
      ? [
          {
            question: `How do I ${lowercaseFirst(firstOp.name)} with ${name} in Ame?`,
    ...
    ...(triggerCount > 0
      ? [
          {
            question: `How do I trigger a Ame agent from ${name} automatically?`,
            answer: `Add ${articleFor(name)} ${name} trigger block to your agent and copy its generated webhook URL into ${name}'s webhook settings. Ame supports ${triggersPhrase} for ${name}: ${triggerListPhrase}. Once configured, every matching ${name} event starts your agent instantly, no polling, no delay.`,
          },
          {
            question: `What data does Ame receive when a ${name} event triggers an agent?`,
...
export async function generateMetadata({
  ...
  const metaDesc =
    seo?.description ??
    `Automate ${name} with AI agents in Ame. ${sentenceWithTerminalPunctuation(truncate(description, 100))} Free to start.`
  ...
  return {
    ...
    openGraph: {
      title: seo?.title ?? `${name} Integration | Ame AI Workspace`,
      description:
        seo?.description ??
    ...
    twitter: {
      ...
      title: seo?.title ?? `${name} Integration | Ame`,
      description:
        seo?.description ??
        `Automate ${name} with AI agents in Ame. Connect to ${INTEGRATION_COUNT - 1}+ tools. Free to start.`,
    },
  ...
  return (
    <section className='bg-[var(--bg)]'>
      ...
      <div className='mx-auto w-full max-w-[1460px] px-20 pt-[112px] max-sm:px-5 max-sm:pt-20 max-lg:px-8'>
        ...
        <p className='sr-only'>
          {name} is a {categoryLabel} integration for Ame, the AI workspace where teams build and
          deploy AI agents. Ame&apos;s {name} integration provides{' '}
          {[
            operations.length > 0
      ...
      <div className='mx-20 max-w-[1300px] border-[var(--border)] border-x max-sm:mx-5 max-lg:mx-8 min-[1460px]:mx-auto'>
            ...
            {[
              {
                ...
                body: 'Sign up at ame.ai in seconds. No credit card required. Your workspace is ready immediately.',
              },
              {
                step: '02',
          ...
          <section aria-labelledby='triggers-heading'>
            <div className='px-6 pt-10 pb-4'>
              ...
              <p className='text-[14px] text-[var(--text-body)] leading-[150%] tracking-[0.02em]'>
                {seo?.triggersIntro ?? (
                  <>
                    Connect {articleFor(name)} {name} webhook to Ame and your agent runs the instant
        ...
        {operations.length > 0 && (
          <section aria-labelledby='tools-heading'>
            <div className='px-6 pt-10 pb-4'>
              ...
              <p className='text-[14px] text-[var(--text-body)] tracking-[0.02em]'>
                {operations.length} {name} tool{operations.length === 1 ? '' : 's'} available in Ame
        ...
        <section aria-labelledby='cta-heading' className='px-6 py-16 text-center'>
          <div className='mx-auto mb-6 flex items-center justify-center gap-3'>
            <Image
              src='/brandbook/logo/ame-small.svg'
              alt='Ame'
              width={56}
              height={56}
