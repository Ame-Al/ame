...
const CATALOG_FAQS: FAQItem[] = [
  {
    question: 'How do integrations work in Ame?',
    answer: `Each integration is a block you drag onto Ame's workflow builder. Together, Ame's ${INTEGRATION_COUNT} integrations expose ${TOTAL_TOOL_COUNT}+ tools that AI agents can call. ${OAUTH_COUNT} connect with one-click OAuth, and the rest use an API key or no authentication at all. Wire blocks together, add an AI agent block for reasoning, and run.`,
  },
  {
    question: 'Are Ame integrations free to use?',
    answer: `Yes. Ame's free plan includes every integration in the library, all ${INTEGRATION_COUNT} of them, with no credit card required. Create an account at ame.ai and start building.`,
  },
  {
    question: 'Can an AI agent decide when to use an integration?',
    answer: `Yes. This is the core of Ame. You give an agent access to integration tools and describe the goal in plain language; the agent decides which tools to call, in what order, and how to handle the results. Automations adapt to context instead of breaking when inputs change.`,
  },
  {
    question: 'Can external events trigger my agents automatically?',
    answer: `Yes. ${TRIGGER_INTEGRATION_COUNT} Ame integrations include real-time webhook triggers. Add a trigger block to your agent, copy its webhook URL into the external service, and every matching event starts your agent instantly, no polling, no delay.`,
  },
  {
    question: 'How many integrations does Ame support?',
    answer: `Ame supports ${INTEGRATION_COUNT} integrations across messaging, CRMs, databases, developer tools, AI providers, and more, and the catalog grows continually. If a tool you need is missing, request it below and we'll prioritize it.`,
  },
]
...
export async function generateMetadata({
  ...
  return withFilteredNoindex(
    {
      title: 'Integrations',
      description: `Connect ${INTEGRATION_COUNT}+ apps and services in Ame's AI workspace. Build agents that automate real work with ${TOP_NAMES.join(', ')}, and more.`,
      keywords: [
      ...
      openGraph: {
        ...
        description: `Connect ${INTEGRATION_COUNT}+ apps in Ame's AI workspace. Build agents that link ${TOP_NAMES.join(', ')}, and every tool your team uses.`,
        url: `${baseUrl}/integrations`,
        type: 'website',
      },
      twitter: {
        card: 'summary_large_image',
        title: 'Integrations | Ame',
        description: `Connect ${INTEGRATION_COUNT}+ apps in Ame's AI workspace.`,
      },
...
export default async function IntegrationsPage({
  ...
  const itemListJsonLd = {
    ...
    description: `Complete list of ${INTEGRATION_COUNT}+ integrations available in Ame's AI workspace for building and deploying AI agents.`,
    url: `${baseUrl}/integrations`,
