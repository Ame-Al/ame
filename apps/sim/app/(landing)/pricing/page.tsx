...
const TITLE = 'Pricing | Ame, the AI Workspace'
const DESCRIPTION =
  'Pricing for Ame, the open-source AI workspace for building, deploying, and managing AI agents. Compare the Free, Pro, Max, and Enterprise plans. Start free.'
...
export async function generateMetadata({
  ...
  const base = buildLandingMetadata({
    ...
    path: '/pricing',
    keywords:
      'Ame pricing, AI workspace pricing, AI agent platform pricing, build AI agents, Pro plan, Max plan, Enterprise plan, open-source AI agents, LLM pricing',
  })
