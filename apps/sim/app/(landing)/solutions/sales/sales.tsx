...
export const SALES_PAGE_DESCRIPTION =
  'AI agents for sales teams: automate lead research, personalized outreach, and CRM updates. Built in Ame, the open-source AI workspace.'
...
const SALES_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'Sales',
    heading: 'Automate lead research, outreach, and CRM updates with AI agents in Ame.',
    description:
      'Ame is the open-source AI workspace where sales teams build AI agents for lead research, outreach, and CRM updates. Agents wire into Salesforce, HubSpot, and 1,000+ integrations to keep the pipeline current.',
    summary:
      'Ame is the open-source AI workspace where sales teams build, deploy, and manage AI agents for lead research, personalized outreach, and CRM updates. Agents wire into Salesforce, HubSpot, and 1,000+ integrations so the pipeline stays current.',
    visual: (
      <PlatformHeroVisual>
        <SalesHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle: 'Ame agents handle research, outreach, and follow-up around the clock.',
      cta: { label: 'See sales agents', href: '/signup' },
      cards: [
        {
          title: 'Route inbound leads',
          description: 'Ame scores, routes, and follows up on new leads the moment they arrive.',
        ...
        },
        {
          ...
          description:
            'Ame researches the company, the news, and the stack, and writes the brief before you call.',
          visual: (
            <KnowledgeAnswerGraphic
        ...
        },
        {
          ...
          description:
            'Ame drafts personalized outbound from the research, in your voice, ready to send.',
          visual: (
            <DocumentDraftGraphic
    ...
    },
    {
      ...
      subtitle: 'Ame keeps records current so the forecast is built on real data.',
      cta: { label: 'Explore CRM automation', href: '/signup' },
      cards: [
        {
          title: 'Update the CRM',
          description: 'Ame logs calls, sets next steps, and moves stages after every touchpoint.',
          visual: (
            <StagingGraphic
              title='Opportunity'
              headerTag='$48,000'
              ...
              attribution='Updated by Ame · 2m ago'
        ...
        },
        {
          ...
          description: 'Ame assembles a brief before every call from your CRM, email, and notes.',
          visual: (
            <ItPlatformTeamsGraphic
              title='Meeting prep'
              badgeLabel='Daily'
        ...
        },
        {
          ...
          description: 'Ame assembles pipeline and forecast digests from your CRM on schedule.',
          visual: (
            <RunMonitoringGraphic
