...
export const ENGINEERING_PAGE_DESCRIPTION =
  'AI agents for engineering teams: automate code review, on-call triage, and documentation. Built in Ame, the open-source AI workspace.'
...
const ENGINEERING_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'Engineering',
    heading: 'Automate code review, on-call, and docs with AI agents in Ame.',
    description:
      'Ame is the open-source AI workspace where engineering teams build AI agents for code review, on-call, and docs. Agents wire into GitHub, CI/CD, and 1,000+ integrations across the software lifecycle.',
    summary:
      'Ame is the open-source AI workspace where engineering teams build, deploy, and manage AI agents for code review, on-call triage, and documentation. Agents wire into GitHub, CI/CD, and 1,000+ integrations across the software lifecycle.',
    visual: (
      <PlatformHeroVisual>
        <EngineeringHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle: 'Ame agents take the repetitive engineering work off your plate.',
      cta: { label: 'See engineering agents', href: '/signup' },
      cards: [
        {
          title: 'Review pull requests',
          description:
            'Ame agents review diffs, flag risks, and leave inline comments before a human looks.',
          visual: <TechnicalTeamsGraphic />,
        },
        {
          title: 'Triage on-call',
          description:
            'Ame reads alerts, gathers context, and proposes a fix so on-call starts ahead.',
        ...
        {
          title: 'Generate docs',
          description: 'Ame keeps READMEs and runbooks in sync with the code as it changes.',
          visual: (
    ...
    },
    {
      ...
      subtitle: 'Ame connects the systems engineering already runs on.',
      cta: { label: 'Browse integrations', href: '/signup' },
      cards: [
        {
          title: 'GitHub and GitLab',
          description: 'Ame agents act on issues, PRs, and releases across your repositories.',
          visual: (
            <StagingGraphic
              title='Pull request'
              headerTag='#482'
        ...
        },
        {
          ...
          description:
            'Ame triggers on builds and deploys, so agents react the moment something ships.',
          featureTileTone: 'dark',
          featureTileDescriptionTone: 'soft',
          visual: (
            <DeployGraphic
        ...
        },
        {
          title: 'Observability',
          description:
            'Ame pulls from your logs and traces to give agents real production context.',
          visual: (
            <RunMonitoringGraphic
              fields={[
