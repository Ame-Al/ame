...
export const FINANCE_PAGE_DESCRIPTION =
  'AI agents for finance teams: automate invoice processing, reconciliation, and financial reporting. Built in Ame, the open-source AI workspace.'
...
const FINANCE_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'Finance',
    heading: 'Automate invoice processing, reconciliation, and close with AI agents in Ame.',
    description:
      'Ame is the open-source AI workspace where finance teams build AI agents for invoice processing, reconciliation, and close. Human approvals, anomaly detection, and full audit trails guard every run.',
    summary:
      'Ame is the open-source AI workspace where finance teams build, deploy, and manage AI agents for invoice processing, reconciliation, and financial reporting. Agents run with human approvals, anomaly detection, and full audit trails across 1,000+ integrations.',
    visual: (
      <PlatformHeroVisual>
        <FinanceHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle: 'Ame agents handle the manual reconciliation work every cycle.',
      cta: { label: 'See finance agents', href: '/signup' },
      cards: [
        {
          title: 'Reconcile accounts',
          description:
            'Ame matches transactions across systems and flags only the exceptions for review.',
          visual: <ReconcileGraphic />,
        },
        {
          title: 'Process invoices',
          description:
            'Ame reads, codes, and routes invoices for approval without manual data entry.',
        ...
        },
        {
          title: 'Build reports',
          description:
            'Ame assembles recurring financial reports from your source systems on schedule.',
          visual: (
    ...
    },
    {
      ...
      subtitle: 'Ame keeps a human in the loop and a record of every decision.',
      cta: { label: 'Explore controls', href: '/signup' },
      cards: [
        {
          title: 'Route approvals',
          description: 'Ame sends the right items to the right approver and waits before it acts.',
          visual: (
            <StagingGraphic
              title='Invoice'
              headerTag='#2041'
              ...
              attribution='Routed by Ame · 2m ago'
        ...
        },
        {
          ...
          description: 'Ame watches spend and flags unusual transactions before they post.',
          visual: (
            <RunMonitoringGraphic
              title='Spend monitor'
              fields={[
        ...
        },
        {
          ...
          description: 'Ame logs every run block by block, so finance can prove every control.',
          visual: (
            <AuditTrailGraphic
              entries={[
                {
