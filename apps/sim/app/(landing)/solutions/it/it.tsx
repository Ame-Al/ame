...
export const IT_PAGE_DESCRIPTION =
  'AI agents for IT teams: automate ticket triage, access provisioning, and infrastructure monitoring. Built in Ame, the open-source AI workspace.'
...
const IT_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'IT',
    heading: 'Automate ticket triage, access, and monitoring with AI agents in Ame.',
    description:
      'Ame is the open-source AI workspace where IT teams build AI agents for ticket triage, access, and monitoring. Agents run with governance, access controls, and audit trails across 1,000+ integrations.',
    summary:
      'Ame is the open-source AI workspace where IT teams build, deploy, and manage AI agents for ticket triage, access provisioning, and infrastructure monitoring. Agents run with IT-grade governance and audit trails across 1,000+ integrations and every major LLM.',
    visual: (
      <PlatformHeroVisual>
        <ItHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle: 'Ame agents handle the repetitive front line so your team works on what matters.',
      cta: { label: 'See IT agents', href: '/signup' },
      cards: [
        {
          title: 'Triage tickets',
          description:
            'Ame routes, tags, and resolves incoming tickets across your help desk automatically.',
        ...
        },
        {
          ...
          description:
            'Ame grants and revokes access by policy, so requests are handled in seconds, not days.',
          visual: <AccessControlGraphic />,
        },
        {
          title: 'Answer common questions',
          description: 'Ame deploys an internal help-desk agent that answers from your own docs.',
    ...
    },
    {
      ...
      subtitle: 'Ame watches your stack and acts before small issues become outages.',
      cta: { label: 'Explore monitoring', href: '/signup' },
      cards: [
        {
          title: 'Monitor infrastructure',
          description:
            'Ame agents watch logs and metrics and flag anomalies the moment they appear.',
          visual: (
            <RunMonitoringGraphic
              fields={[
        ...
        },
        {
          ...
          description:
            'Ame runs your runbooks automatically and escalates to the right on-call engineer.',
          visual: (
            <ItPlatformTeamsGraphic
              title='Incident'
              badgeLabel='Runbook'
        ...
        },
        {
          ...
          description:
            'Ame logs every agent run block by block, so IT can prove exactly what happened.',
