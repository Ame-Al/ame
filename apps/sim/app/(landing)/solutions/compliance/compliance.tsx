...
export const COMPLIANCE_PAGE_DESCRIPTION =
  'AI agents for compliance teams: automate evidence collection, control monitoring, and audit reports. Built in Ame, the open-source AI workspace.'
...
const COMPLIANCE_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'Compliance',
    heading: 'Automate evidence, control checks, and audit reports with AI agents in Ame.',
    description:
      'Ame is the open-source AI workspace where compliance teams build AI agents for evidence collection and control monitoring. Stay audit-ready year-round, across 1,000+ integrations.',
    summary:
      'Ame is the open-source AI workspace where compliance teams build, deploy, and manage AI agents for evidence collection, control monitoring, and audit reports. Agents keep the organization audit-ready year-round across 1,000+ integrations.',
    visual: (
      <PlatformHeroVisual>
        <ComplianceHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle: 'Ame agents collect and check the proof so audits stop being fire drills.',
      cta: { label: 'See compliance agents', href: '/signup' },
      cards: [
        {
          title: 'Collect evidence',
          description:
            'Ame gathers screenshots, logs, and records from your systems on a schedule.',
          visual: (
            <ItPlatformTeamsGraphic
              title='Evidence'
        ...
        },
        {
          ...
          description: 'Ame continuously checks controls and flags drift the moment it appears.',
        ...
        },
        {
          ...
          description:
            'Ame reviews changes against your policies and raises anything out of bounds.',
          visual: (
            <TechnicalTeamsGraphic
              diffLines={[
    ...
    },
    {
      id: 'prove',
      title: 'Prove control.',
      subtitle: 'Ame turns continuous monitoring into a clean, defensible record.',
      cta: { label: 'Explore reporting', href: '/signup' },
      cards: [
        {
          title: 'Review access',
          description: 'Ame runs periodic access reviews and routes exceptions for sign-off.',
          visual: <AccessControlGraphic />,
        },
        {
          title: 'Generate reports',
          description:
            'Ame assembles audit-ready reports from live evidence, not stale spreadsheets.',
          visual: (
        ...
        },
        {
          ...
          description: 'Ame logs every run block by block, so auditors see exactly what happened.',
