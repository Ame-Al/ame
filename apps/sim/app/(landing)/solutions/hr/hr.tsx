...
export const HR_PAGE_DESCRIPTION =
  'AI agents for HR teams: automate onboarding, employee questions, and approvals. Built in Ame, the open-source AI workspace.'
...
const HR_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'HR',
    heading: 'Automate onboarding, employee questions, and approvals with AI agents in Ame.',
    description:
      'Ame is the open-source AI workspace where HR teams build AI agents for onboarding, employee questions, and approvals. Agents wire into your HRIS and 1,000+ integrations to keep people operations moving.',
    summary:
      'Ame is the open-source AI workspace where HR teams build, deploy, and manage AI agents for onboarding, employee questions, and approvals. Agents connect your HRIS and 1,000+ integrations so people operations keep moving.',
    visual: (
      <PlatformHeroVisual>
        <HrHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle: 'Ame agents handle the repetitive people-ops work end to end.',
      cta: { label: 'See HR agents', href: '/signup' },
      cards: [
        {
          title: 'Onboard new hires',
          description:
            'Ame runs the onboarding checklist across every system so day one just works.',
        ...
        },
        {
          ...
          description:
            'Ame deploys an agent that answers policy and benefits questions from your docs.',
          visual: (
            <KnowledgeAnswerGraphic
        ...
        },
        {
          ...
          description:
            'Ame drafts offer letters and policy docs from your templates automatically.',
          visual: (
            <DocumentDraftGraphic
              title='Offer letter'
    ...
    },
    {
      id: 'run',
      title: 'Run the team.',
      subtitle: 'Ame keeps people operations moving without the manual chase.',
      cta: { label: 'Explore HR automation', href: '/signup' },
      cards: [
        {
          title: 'Route approvals',
          description:
            'Ame sends PTO and expense requests to the right manager and tracks the response.',
          visual: (
            <StagingGraphic
              title='PTO request'
              headerTag='5 days'
        ...
        {
          title: 'Run surveys',
          description: 'Ame collects and summarizes engagement feedback so trends surface early.',
          visual: (
            <ItPlatformTeamsGraphic
              title='Surveys'
        ...
        {
          title: 'Build reports',
          description: 'Ame assembles headcount and people reports from your HRIS on schedule.',
          visual: (
            <RunMonitoringGraphic
              title='People report'
              fields={[
