...
export const WORKFLOWS_PAGE_DESCRIPTION =
  "Ame's AI workflow builder connects blocks, every major LLM, and 1,000+ integrations into agents. Build Slack bots and data pipelines visually or in code."
...
const WORKFLOWS_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'Workflows',
    heading: 'Build AI agent workflows visually in Ame.',
    description:
      'Workflows is the visual AI workflow builder in Ame, the open-source AI workspace. Connect blocks, every major LLM, and 1,000+ integrations into Slack bots, compliance agents, and data pipelines.',
    summary:
      'Workflows is the visual AI workflow builder in Ame, the open-source AI workspace where teams build, deploy, and manage AI agents. Teams wire blocks, every major LLM, and 1,000+ integrations into agent logic, then deploy and trace every run without leaving Ame.',
    visual: (
      <PlatformHeroVisual>
        <WorkflowsEditorLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle:
        'Ame lets teams build agents visually, in natural language, or with code, wiring up any model and 1,000+ integrations in one workspace.',
      cta: { label: 'Explore the workflow builder', href: '/signup' },
      cards: [
        {
          title: 'Drag and connect',
          description:
            'Wire blocks, models, and integrations on the visual builder. Ame turns the graph into agent logic you can run.',
          visual: <WorkflowCanvasGraphic />,
        },
        {
          title: 'Describe it in words',
          description:
            'Tell Ame what the agent should do in plain language, and the workspace assembles the workflow for you.',
          visual: <BuildMethodsGraphic />,
        },
        {
          title: 'Drop into code',
          description:
            'Reach for code blocks when you need exact control. Ame runs your logic alongside every other block.',
    ...
    {
      id: 'deploy',
      title: 'Deploy and run without leaving Ame.',
      subtitle:
      ...
      cards: [
        {
          ...
          description:
            'Ame exposes every workflow as an endpoint, so any system can call your agent with one request.',
          featureTileTone: 'dark',
          featureTileDescriptionTone: 'soft',
          visual: (
            <DeployGraphic
              url='ame.ai/api/agents/support'
        ...
        },
        {
          ...
          description:
            'Set agents to run on a cadence. Ame handles the triggers so the work happens on its own.',
          visual: <RunMonitoringGraphic />,
        },
        {
          title: 'Connect to Slack',
          description:
            'Turn a workflow into a Slack bot your team talks to. Ame wires the integration end to end.',
          visual: (
            <KnowledgeAnswerGraphic
              question='@ame how do refunds work for annual plans?'
        ...
        },
        {
          ...
          description:
            'Ame logs each run block by block, so teams see exactly what an agent did and why.',
          visual: (
            <AuditTrailGraphic
              entries={[
                {
