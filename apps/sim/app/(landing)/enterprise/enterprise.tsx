...
export const ENTERPRISE_SEO_DESCRIPTION =
  'Build and govern enterprise AI agents in Ame with SSO, approvals, audit trails, versioning, and 1,000+ integrations.'
  ...
  rows: [
    {
      ...
      subtitle:
        'Ame takes enterprise AI agents from initial design to production in one workspace. Build visually or with code, validate changes, deploy approved versions, and monitor every run without connecting separate development and operations tools.',
      cta: { label: 'Start building', href: SIGNUP_HREF },
      cards: [
        {
          title: 'Build visually or with code',
          description:
            "Create enterprise AI agents in Ame's visual builder, describe the workflow in plain English, or write custom logic directly in code.",
        ...
        },
        {
          ...
          description:
            'Version, monitor, and update every enterprise AI agent in Ame as your business requirements, integrations, and governance policies evolve.',
    ...
    },
    {
      ...
      subtitle:
        'Control how enterprise AI agents access data, use tools, and take action. Ame provides SSO, permission groups, approval paths, configurable data retention, and append-only audit logs for every security-relevant change.',
      ...
      cards: [
        ...
        },
        {
          ...
          description: 'Ame traces every run block by block with a complete audit trail.',
          visual: <AuditTrailGraphic />,
        },
        {
          title: 'Meet enterprise standards',
          description:
            'Ame is SOC2 compliant and open source, giving security teams a clear path to review.',
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          description: 'Ame shows live logs, run history, and monitoring in one place.',
          visual: <RunMonitoringGraphic />,
        },
        {
          title: 'Roll back safely',
          description: 'Ame versions workflows so you can roll back production agents in seconds.',
    ...
    },
    {
      ...
      subtitle:
        'IT, operations, and engineering teams share one Ame workspace, each with the controls their role needs.',
      ...
      cards: [
        ...
        },
        {
          ...
          description: 'Technical teams ship, review, and maintain agents together in Ame.',
