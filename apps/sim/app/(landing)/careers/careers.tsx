...
export default async function Careers({ searchParams }: CareersProps) {
  ...
  return (
    <main id='main-content'>
      ...
      >
        <p className='sr-only'>
          Careers at Ame, the open-source AI workspace where teams build, deploy, and manage AI
          agents. Ame is hiring engineers, designers, and go-to-market builders to help teams
        ...
        >
          Help build Ame, the AI workspace for teams.
        </h1>
        <p className='max-w-[60ch] text-pretty text-[var(--text-body)] text-lg leading-[1.5] max-sm:text-base'>
          Ame is the open-source AI workspace where teams build, deploy, and manage AI agents. We're
