...
export async function generateMetadata({
  ...
  const base = buildLandingMetadata({
    title: 'Careers | Ame, the AI Workspace',
    description:
      'Join Ame, the open-source AI workspace where teams build, deploy, and manage AI agents. See open engineering, design, and go-to-market roles.',
    path: '/careers',
    keywords:
      'Ame careers, Ame jobs, AI workspace jobs, AI agent engineering jobs, open source jobs',
  })
