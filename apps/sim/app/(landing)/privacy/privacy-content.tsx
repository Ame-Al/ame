...
export const PRIVACY_CONFIG: LegalPageConfig = {
  ...
  intro: [
    {
      kind: 'paragraph',
      content: `This Privacy Policy describes how Ame ("we", "us", "our", or "the Service") collects, uses, discloses, and protects personal data, including data obtained from Google APIs (including Google Workspace APIs), and your rights and controls regarding that data.`,
    },
    {
      kind: 'paragraph',
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { kind: 'paragraph', content: `For the purposes of this Privacy Policy:` },
        {
          ...
          items: [
            <>
              <strong>Application</strong> or <strong>Service</strong> means the Ame web or mobile
            ...
            <>
              ...
              this Agreement) refers to Ame. For the purpose of the GDPR, the Company is the Data
              Controller.
            </>,
            <>
            ...
            <>
              <strong>Website</strong> refers to Ame, accessible from ame.ai
            </>,
            <>
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            `Content you upload (e.g., documents, files) within Ame`,
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          content: (
            <>
              <strong>Importantly:</strong> any Google Data used within Ame is used only for
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          content: `Ame may disclose your Personal Information in the good faith belief that such action is necessary to:`,
        },
        {
          kind: 'list',
          items: [
            `To comply with a legal obligation`,
            `To protect and defend the rights or property of Ame`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          content: `Ame's use, storage, processing, and transfer of Google Data (raw or derived) strictly adheres to the Google API Services User Data Policy, including the Limited Use requirements, and to the Google Workspace API user data policy (when applicable). We explicitly affirm that:`,
        },
        {
          kind: 'list',
          items: [
            `Ame does not use, transfer, or allow Google Data to be used to train, improve, or develop generalized or non-personalized AI/ML models.`,
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          content: `If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Ame aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Information.`,
        },
        {
          kind: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            `The right to withdraw consent. You also have the right to withdraw your consent at any time where Ame relied on your consent to process your personal information.`,
          ],
        },
        {
          kind: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          content: `Security research carried out in conformity with this policy is deemed permissible. We'll work with you to swiftly understand and fix the problem, and Ame will not suggest or pursue legal action in connection with your study.`,
        },
        ...
        {
          kind: 'list',
          items: [`ame.ai website`, `Ame web application`, `Ame API services`],
        },
        {
          kind: 'paragraph',
          content: (
            <>
              ...
              solutions Ame interacts with are not covered by this policy and should be reported
