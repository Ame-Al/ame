...
export const FILES_PAGE_DESCRIPTION =
  'Files is the file storage for AI agents and teams in Ame. Upload, create, and share in one store, and agents read files as inputs and write outputs back.'
...
const FILES_CONFIG: SolutionsPageConfig = {
  ...
  hero: {
    eyebrow: 'Files',
    heading: 'One file store for your team and every agent in Ame.',
    description:
      'Files is the file storage for teams and every AI agent in Ame, the open-source AI workspace. Upload, create, and share. Agents read files as inputs and produce new files as outputs.',
    summary:
      'Files is the file storage for teams and AI agents in Ame, the open-source AI workspace where teams build, deploy, and manage AI agents. Teams upload, create, and share files, and agents read them as inputs, parse them, and produce new files as outputs.',
    visual: (
      <PlatformHeroVisual>
        <FilesHeroLoop />
      </PlatformHeroVisual>
  ...
  rows: [
    {
      ...
      subtitle:
        'Ame keeps uploads, agent outputs, and shared documents in a single store your whole workspace can reach.',
      cta: { label: 'Explore Files', href: '/signup' },
      cards: [
        {
          title: 'One shared library',
          description:
            "Ame stores your team's uploads and your agents' outputs side by side, so nothing lives in a silo.",
          visual: <FileLibraryGraphic />,
        },
        {
          title: 'Files flow through workflows',
          description:
            'Ame routes files from uploads, email, and drives into agent runs, then delivers the results where your team works.',
        ...
        },
        {
          ...
          description:
            'Ame logs every upload, parse, and share, so teams always know where a file came from.',
          visual: (
            <AuditTrailGraphic
              entries={[
                {
    ...
    },
    {
      ...
      subtitle:
        'Ame agents take files as inputs, pull the data out, and write new files back to the store for your team.',
      cta: { label: 'Build a file-handling agent', href: '/signup' },
      cards: [
        {
          title: 'Read and parse anything',
          description:
            'Ame agents take PDFs, spreadsheets, and docs as inputs and pull out the fields your workflow needs.',
          visual: (
            <RunMonitoringGraphic
              title='Parse run'
              fields={[
        ...
        },
        {
          ...
          description:
            'Ame agents draft reports, exports, and summaries, then save them to Files for the whole team.',
          visual: (
        ...
        },
        {
          ...
          description:
            "Ame's SDK gives every agent the same file store, so code reads inputs and uploads outputs in a few lines.",
          featureTileTone: 'dark',
          featureTileDescriptionTone: 'soft',
