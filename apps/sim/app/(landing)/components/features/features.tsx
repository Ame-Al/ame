  ...
  return (
    <section id='features' aria-labelledby='features-heading' className='relative w-full'>
      <h2 id='features-heading' className='sr-only'>
        Integrate your tools, give Ame context, build agents, and monitor every run.
      </h2>
      ...
      <div className='mx-auto grid w-full max-w-[1460px] grid-cols-1 gap-28 px-20 max-sm:gap-12 max-sm:px-5 max-lg:px-8'>
        ...
        <FeatureCard
          ...
          description='Plug in 1,000+ integrations like Slack, HubSpot, Salesforce, and Notion, so Ame agents act across the stack you already use.'
          href='/integrations'
        ...
        <FeatureCard
          eyebrow='Context'
          title='Give Ame data it can reason over.'
          description='Ame stores your data in tables, files, and knowledge bases, the semantic memory agents read to ground every answer.'
        ...
        <FeatureCard
          ...
          description="Wire blocks, models, and integrations into agent logic on Ame's visual builder, from one agent to many working in parallel."
          href='/workflows'
        ...
        <FeatureCard
          ...
          description='Ame traces each run block by block, with full logs and the real cost.'
