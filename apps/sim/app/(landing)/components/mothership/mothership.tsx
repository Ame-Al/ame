...
const AREAS: Area[] = [
  {
    ...
    definition: (
      <>
        Ame&apos;s catalog of 1,000+ integrations
        <br />
  ...
  },
  {
    ...
    size: 170,
    definition: 'Your data, stored semantically in Ame as the memory your agents reason over.',
  },
  {
    word: 'Build',
    Mark: IsoBuildIllustration,
    size: 176,
    definition: 'Compose agent logic in the visual builder, or just describe it to Ame.',
  },
  {
    word: 'Monitor',
    Mark: IsoMonitorIllustration,
    size: 174,
    definition: 'See inside every run in Ame: live traces, logs, and real cost.',
  },
]
