    ...
    <main id='main-content'>
      ...
      >
        <div className='flex flex-col gap-5 xl:col-start-1 xl:row-start-1 xl:self-start xl:pt-[80px]'>
          <p className='sr-only'>
            Operationalize AI with Ame, the AI agent workspace where teams build, deploy, and manage
            AI agents and workflows. A Ame specialist walks your team through building agents that
          ...
          >
            Operationalize AI with Ame, <br />
            the AI agent workspace.
          </h1>
          <p className='max-w-[46ch] text-pretty text-[var(--text-body)] text-lg leading-[1.5] max-sm:text-base'>
            Tell us what you're working on and we'll show you how teams use Ame to build, deploy,
