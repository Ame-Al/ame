  ...
  intro: [
    {
      ...
      content: (
        <>
          This Cookie Policy explains how Ame uses cookies and similar technologies on ame.ai and in
          the Ame application, what each one does, and the choices you have. It forms part of our{' '}
  ...
  sections: [
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            <>
              <strong>Analytics</strong> — how many people use Ame, which pages and features they
              reach, and where errors happen, so we can improve the product. Measurement only; we do
              not use these to target advertising.
            </>,
            <>
              <strong>Marketing</strong> — measuring which campaigns bring builders to Ame and
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          content: `Retention periods are the maximum lifetime set when the cookie is written; a cookie can be cleared sooner at any time. Third-party providers occasionally rename or re-scope their cookies, so treat the provider column as the authoritative reference for anything not set by Ame.`,
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          content: `Independently of the banner, every major browser lets you block or delete cookies from its privacy settings, and can be set to clear them each time you close it. Blocking necessary cookies will sign you out and prevent parts of Ame from working.`,
        },
        {
          kind: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          content: `Some cookies above are set by companies we work with rather than by Ame. We choose these providers and decide when their code loads, but the data they collect is also governed by their own policies, which we cannot change on your behalf.`,
        },
        {
          kind: 'paragraph',
          content: (
