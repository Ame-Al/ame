...
export function StructuredData({
  ...
  const softwareStructuredData = {
    ...
    operatingSystem: 'Any',
    description:
      'Ame is the open-source AI workspace where teams build, deploy, and manage AI agents. Connect 1,000+ integrations and every major LLM to create agents that automate real work.',
    url: baseUrl,
    author: {
      '@type': 'Organization',
      name: 'Ame Team',
