...
Webhooks ermöglichen externen Diensten die Ausführung von Workflows durch das Senden von HTTP-Anfragen an Ihren Workflow. Ame unterstützt zwei Ansätze für webhook-basierte Auslöser.
