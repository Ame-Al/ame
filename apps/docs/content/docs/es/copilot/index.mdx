...
Copilot es tu asistente integrado en el editor que te ayuda a crear y editar flujos de trabajo con Ame Copilot, así como a entenderlos y mejorarlos. Puede:

- **Explicar**: Responder preguntas sobre Ame y tu flujo de trabajo actual
...
<Callout type="info">
  Copilot es un servicio gestionado por Ame. Para implementaciones autoalojadas, genera una clave API de Copilot en la aplicación alojada (ame.ai → Configuración → Copilot)
  1. Ve a [ame.ai](https://sim.ai) → Configuración → Copilot y genera una clave API de Copilot
...
- **Documentación**: Referencia la documentación de Ame
