...
Copilot est votre assistant intégré à l'éditeur qui vous aide à créer et à modifier des flux de travail avec Ame Copilot, ainsi qu'à les comprendre et à les améliorer. Il peut :

- **Expliquer** : répondre aux questions sur Ame et votre flux de travail actuel
...
<Callout type="info">
  Copilot est un service géré par Ame. Pour les déploiements auto-hébergés, générez une clé API Copilot dans l'application hébergée (ame.ai → Paramètres → Copilot)
  1. Allez sur [ame.ai](https://sim.ai) → Paramètres → Copilot et générez une clé API Copilot
...
- **Documentation** : référencer la documentation de Ame
