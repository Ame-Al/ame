...
`sim` is the command line for Ame. Sign in once, then run workflows, query tables,
...
Using Ame as a library instead? See the [TypeScript](/api-reference/typescript)
