...
| `--endpoint <url>` | Ame deployment to talk to (env: SIM_ENDPOINT). |
...
| Option | Required | Description |
| --- | --- | --- |
| `--set-endpoint <url>` | No | Ame deployment to talk to. |
...
| Option | Required | Description |
| --- | --- | --- |
| `--source <value>` | No | Filter by usage source; ame-chat combines Copilot and workspace chat. Accepted values: `workflow`, `wand`, `sim-chat`, `mcp_copilot`, `mothership_block`, `knowledge-base`, `voice-input`, `enrichment`, `voice-output`. |
...
### ame credentials providers list
...
| Option | Required | Description |
| --- | --- | --- |
| `--name <displayName>` | Yes | Name shown for the credential in Ame. |
...
| Option | Required | Description |
| --- | --- | --- |
| `--name <displayName>` | Yes | Name shown for the new credential in Ame. |

</CommandTable>

### ame credentials reconnect
...
### ame knowledge documents batch-update
...
### ame knowledge documents delete
...
### ame knowledge documents update
...
### ame knowledge documents upload
...
### ame knowledge connectors create
...
### ame knowledge connectors delete
...
### ame knowledge connectors documents list
...
### ame knowledge connectors update
...
### ame knowledge connectors documents update
...
### ame workflows deployment status
