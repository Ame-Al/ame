...
<FAQ items={[
  ...
  { question: "Do I need API keys to follow this tutorial?", answer: "No. On hosted Ame, the model and the search tools run on Ame's hosted keys, included with your plan credits. You can bring your own provider keys if you prefer." },
  ...
  { question: "Can I import workflows from other tools?", answer: "Not directly. But you can describe what you want to Ame in natural language and have it build the workflow for you, which is usually faster than manual recreation." },
