...
Your Ame workspace is where your AI systems live. A system is made of two things. **Workflows** are the procedures it runs. **Resources** are the data those procedures work with: tables, knowledge bases, and files.
...
{/* VISUAL: system-context diagram. Ame builds; tables/KBs/files/integrations feed; deployments expose; logs verify. */}

- **Ame** builds and edits workflows in natural language from Chat.
