...
<Image src="/static/mothership/table-example.png" alt="Chat resource panel showing the pipeline_deals table with company, deal_owner, stage, and amount columns, alongside a chat summary of total pipeline value and breakdown by stage" width={900} height={500} />
...
Describe the schema and Ame creates the table:
...
Ame translates the question into a structured query and returns the results.
...
<FAQ items={[
  { question: "Can Ame join or combine data from multiple tables?", answer: "Yes. Describe the relationship and what you want — Ame will query both tables and combine the results." },
  { question: "Is there a row limit?", answer: "There is no hard row limit set by Ame. Performance for very large tables may vary." },
