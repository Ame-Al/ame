---
title: Whitelabeling
description: Replace Ame branding with your own logo, colors, and links
---

import { FAQ } from '@/components/ui/faq'
import { Image } from '@/components/ui/image'

Whitelabeling lets you replace Ame's default branding — logo, colors, and support links — with your own. Members of your organization see your brand instead of Ame's throughout the workspace.
...
| **Brand name** | Replaces "Ame" in the sidebar and select UI elements. Max 64 characters. |
...
Replace Ame's default support and legal links with your own.
...
- **Sidebar logo and wordmark** — your uploaded images replace the Ame logo
...
<FAQ items={[
  {
    ...
    answer: "Organization owners and admins can configure whitelabeling. On Ame Cloud, you must be on the Enterprise plan."
  },
  {
