...
Ame Enterprise adds fine-grained access control, SSO, audit logging, compliance features, and workspace forking on top of Team plans.
...
Replace Ame's default branding — logos, product name, and favicons — with your own. See the [whitelabeling guide](/platform/enterprise/whitelabeling).
...
<FAQ items={[
  ...
  { question: "Which SSO providers are supported?", answer: "Ame supports SAML 2.0 and OIDC, which works with virtually any enterprise identity provider including Okta, Azure AD (Entra ID), Google Workspace, ADFS, and OneLogin." },
