...
Signs a member out after this many hours without activity. Activity extends the session, so members who use Ame regularly stay signed in; dormant sessions expire.
