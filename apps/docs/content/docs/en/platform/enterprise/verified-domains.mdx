...
2. Ame shows a DNS **TXT record** to publish — a host (`_sim-challenge.acme.com`) and a unique value (`sim-domain-verification=…`).
3. Add that TXT record at your DNS provider.
4. Click **Verify**. Ame looks up the record; on success the domain is marked **Verified**.
