...
If users reach Ame from more than one origin — an apex and `www`, or an alias domain — list the extras:
...
Three providers are supported for signing in to Ame itself.
