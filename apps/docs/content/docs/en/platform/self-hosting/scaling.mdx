...
<Callout type="info">
  Replicas lag. Ame routes only latency-tolerant reads to them, but if your replica lags badly, recently written logs may briefly not appear. Monitor replication lag.
</Callout>
