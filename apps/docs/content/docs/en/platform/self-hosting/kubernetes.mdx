---
title: Kubernetes
description: Deploy Ame with Helm
---
...
For nginx-style ingress controllers, raise the body-size and timeout limits — Ame's defaults allow large chat attachments and long-running executions:
