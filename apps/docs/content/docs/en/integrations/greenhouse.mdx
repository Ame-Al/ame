...
With the Greenhouse integration in Ame, you can:
...
Trigger on whichever event types you select for this URL in Greenhouse. Ame does not filter deliveries for this trigger.
