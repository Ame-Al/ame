...
| `limit` | number | No | Maximum number of IOC IDs to return \(default 100\). CrowdStrike publishes no maximum for this endpoint; Ame caps it at 500 to keep a single request bounded |
