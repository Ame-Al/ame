...
- **Move files**: download a document's primary content, or a specific attachment by its OID, into a Ame file — and upload files as primary content or attachments. Ame handles Windchill's CSRF token and its multi-step upload handshake for you.
