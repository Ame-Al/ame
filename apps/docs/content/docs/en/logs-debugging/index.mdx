...
<Image
  ...
  alt="Log Details with the Trace tab open: a CRM sync run's spans, each block with its duration, 11.61s total"
  width={900}
  height={471}
/>
