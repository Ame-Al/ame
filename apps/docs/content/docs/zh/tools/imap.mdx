...
IMAP 邮件触发器可以让你的 Ame 工作流在任何支持 IMAP 协议的邮箱收到新邮件时自动启动。适用于 Gmail、Outlook、Yahoo 及大多数其他邮箱服务商。
...
借助 Ame，IMAP 集成让你能够将邮件变为可操作的自动化来源。无需人工干预，即可直接从邮箱收件箱响应客户咨询、处理通知、启动数据流程等。
{/* MANUAL-CONTENT-END */}
