...
Go to the Ame platform and navigate to **Settings**, then go to **Ame Keys** and click **Create**. See [Authentication](/api-reference/authentication) for details on key types.
</Step>

<Step>
### Find your workflow ID

Open a workflow in the Ame editor. The workflow ID is in the URL:
