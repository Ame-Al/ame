...
To access the Ame API, you need an API key. Ame supports two types of API keys — **personal keys** and **workspace keys** — each with different billing and access behaviors.
...
To generate a personal key, open **Account settings** → **Ame API keys**. Workspace
administrators can create shared keys from **Workspace settings** → **Ame API keys**.
